...
class ARViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if let image = UIImage(named: "mta-3")?.cgImage {
            let referenceImages: Set = [ARReferenceImage(image, orientation: .up, physicalWidth: 0.0699)]
            
            samMitiARView.referenceImages = referenceImages
        }
    }
